...
$bselect = "SELECT * FROM `booking` WHERE userID = '$userID'";
$bresult = mysqli_query($con, $bselect);
                    ...
                    <div class="sec-conteiner">
                        <div class="sec1 sec">
                            <div class="sec-content">
                                <p class="sec-topic">My Bookings</p>
                                <div class="sec-tabs">
                                    <ul>
                                ...
                                <div class="sec-details">
                                    <div class="sec-det-1 sec-det active">
                                        <div class="topel">
                                            <table>
                                                ...
                                                <tr>
                                                    <td><?php echo $brow['bookingID'] ?></td>
                                                    <td><?php echo $brow['spaceID'] ?></td>
                                                    <td><img src="./upload/<?php echo $brow['spaceImg'] ?>" alt="space img"></td>
                                                    <td><?php echo $brow['pName'] ?>,<br> <?php echo $brow['address'] ?>, <?php echo $brow['city'] ?></td>
                                                    <td>at <?php echo $brow['date'] ?><br><?php echo $brow['startTime'] ?> to <?php echo $brow['endTime'] ?></td>
                                                    <td class="action">
                                                        <a href="./bookingupdate.php?update=<?php echo $brow['bookingID'] ?>" class="update">UPDATE</a>
                                                        <a href="./userprofile.php?delete=<?php echo $brow['bookingID'] ?>" class="delete">DELETE</a>
                                                    </td>
                                                </tr>
                                                <?php } ?>
                                            </table>
                                    ...
                                    <div class="sec-det-2 sec-det">
                                        <div class="sec-emp-cont">
                                            ...
                                            <p class="emp-h2">No Bookings found</p>
